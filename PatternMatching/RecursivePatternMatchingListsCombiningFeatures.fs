module RecursivePatternMatchingListsCombiningFeatures

// function that attemps to find various sequences
let rec findSequence l = 
    ...
    | 1 :: 2 :: 3 :: tail ->
        ...
        findSequence tail
    // if neither case matches and items remain recursively call the function
